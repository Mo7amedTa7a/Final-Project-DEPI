...
> ⚠️ **مهم جداً**: الالتزام بالورك فلو هذا لضمان استقرار `main`.
...
### الأمان
- ⚠️ ملف `.env` يجب أن يكون في `.gitignore`
- ⚠️ لا ترفع مفاتيح Firebase إلى Git
- ⚠️ قواعد Firestore الحالية للاختبار فقط - يجب تحديثها للإنتاج
